...
const SavingCalculator = () => {
  ...
  return (
    <div className="p-6 max-w-5xl mt-50 mx-auto bg-[#fcf6ee] shadow-lg rounded-xl border border-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <h3 className="font-semibold text-black notoSerifBold bg-[#fa9632] p-2 rounded">Step 1: Income Details</h3>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-m text-gray-600">First Salary Age</label>
              <input type="number" name="firstSalaryAge" value={inputs.firstSalaryAge} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
            </div>
            <div>
              <label className="block text-m text-gray-600">Current Age</label>
              <input type="number" name="currentAge" value={inputs.currentAge} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
            </div>
            <div>
              <label className="block text-m text-gray-600">First Monthly Salary (₹)</label>
              <input type="number" name="firstMonthlySalary" value={inputs.firstMonthlySalary} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
            </div>
            <div>
              <label className="block text-m text-gray-600">Current Monthly Salary (₹)</label>
              <input type="number" name="currentMonthlySalary" value={inputs.currentMonthlySalary} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
            </div>
          </div>
          <div className="mt-2 p-3 bg-green-100 rounded text-center">
            <p className="text- m font-medium text-green-800">Yearly Growth: {results.cagr}%</p>
          </div>
        </div>

        {/* Step 2: Assets & Loans */}
        <div className="space-y-4">
          <h3 className="font-semibold text-black notoSerifBold bg-[#fa9632] p-2 rounded">Step 2: Net Assets</h3>
          <div className="space-y-3">
            <div>
              <label className="block text-m text-gray-600">Financial Assets (MF, Bank, etc)</label>
              <input type="number" name="financialAssets" value={inputs.financialAssets} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
            </div>
            <div>
              <label className="block text-m text-gray-600">Real Estate (Current Value)</label>
              <input type="number" name="realEstate" value={inputs.realEstate} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-m text-gray-600">Home Loan</label>
                <input type="number" name="homeLoan" value={inputs.homeLoan} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
              </div>
              <div>
                <label className="block text-m text-gray-600">Other Loans</label>
                <input type="number" name="otherLoan" value={inputs.otherLoan} onChange={handleInputChange} className="w-full border p-2 rounded text-black" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-10 bg-slate-900 p-6 rounded-xl border-2 border-dashed border-gray-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
          <div className="p-4 bg-white rounded shadow-sm">
            <p className="text-m text-gray-500 uppercase font-bold">Total Earned</p>
            <p className="text-lg font-mono text-gray-800">₹{results.totalIncome.toLocaleString()}</p>
          </div>
          <div className="p-4 bg-white rounded shadow-sm">
            <p className="text-m text-gray-500 uppercase font-bold">Net Assets</p>
          ...
          <div className="p-4 bg-white rounded shadow-sm border-t-4 border-cyan-500">
            <p className="text-m text-gray-500 uppercase font-bold">Lifetime Saving %</p>
            <p className="text-2xl font-bold text-cyan-600">{results.savingsPercentage}%</p>
          </div>
          <div className="p-4 bg-white rounded shadow-sm">
            <p className="text-m text-gray-500 uppercase font-bold">Avg. Monthly Save</p>
