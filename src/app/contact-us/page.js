...
export default function ContactUs() {
  return (
    <div className="min-h-screen bg-white w-full pb-20">
      ...
      {/* Main Contact Card */}
      <div className="relative -mt-32 max-w-5xl mx-auto bg-[#FBF9F6] rounded-[2.5rem] shadow-2xl z-10 grid grid-cols-1 md:grid-cols-2 overflow-hidden border border-gray-100">
        
        {/* Left Column: Get in Touch */}
        <div className="p-10 md:p-14 md:pr-10 border-b md:border-b-0 md:border-r border-gray-200">
          <h2 className="text-4xl font-serif font-bold text-black mb-4">Get in touch</h2>
          ...
          <div className="space-y-8 text-black">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg mb-1">Head Office 1</h3>
                <p className="text-sm text-gray-700 leading-relaxed">B Wing, Arihant Aura, 201,<br/>Thane, Belapur Rd, Turbhe<br/>MIDC, Navi Mumbai,<br/>Maharashtra 400703</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg mb-1">Head Office 2</h3>
                <p className="text-sm text-gray-700 leading-relaxed">F Wing, Shri Siddhivinayak<br/>SRA Building, 101, Station Rd,<br/>Lokamanya Nagar, Gandhi<br/>Nagar, Vikhroli West,<br/>Mumbai, Maharashtra 400083</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">assetelixir@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">+91 7021089870</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-10 md:p-14">
          ...
          <form className="space-y-6">
            <div>
              ...
              <input type="text" className="w-full bg-white rounded-xl h-12 px-4 outline-none focus:ring-2 focus:ring-[#FACC15]" />
            </div>
            ...
            <div>
              ...
              <input type="email" className="w-full bg-white rounded-xl h-12 px-4 outline-none focus:ring-2 focus:ring-[#FACC15]" />
            </div>

            <div>
              <label className="block text-black text-lg mb-2">Message</label>
              <textarea rows="4" className="w-full bg-white rounded-xl p-4 outline-none focus:ring-2 focus:ring-[#FACC15] resize-none"></textarea>
            </div>
